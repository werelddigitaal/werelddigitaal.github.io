        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl hover:scale-110 transition-transform duration-300">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">React Development Services</h4>
              <p className="text-gray-600 text-center">Geavanceerde webapplicaties en interfaces ontwikkeld met React, waardoor interactie en prestaties naar een hoger niveau worden getild.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl hover:scale-110 transition-transform duration-300">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Logo Design & Branding</h4>
              <p className="text-gray-600 text-center">Creëer een onvergetelijke merkidentiteit met op maat gemaakte logo's en branding die jou onderscheiden van de rest.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl hover:scale-110 transition-transform duration-300">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">E-commerce Integration</h4>
              <p className="text-gray-600 text-center">Laat ons jouw online winkel ontwikkelen en integreren met geavanceerde e-commerce oplossingen voor een naadloze en veilige winkelervaring.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl hover:scale-110 transition-transform duration-300">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">SEO Optimization Services</h4>
              <p className="text-gray-600 text-center">Verbeter je online zichtbaarheid en trek meer organisch verkeer aan met onze op maat gemaakte SEO-optimalisatiediensten.</p>
            </div>
